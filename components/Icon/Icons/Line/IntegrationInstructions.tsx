...
const Icon = ({ size = 46, color = 'currentColor', ...props }) => (
  <Svg
    ...
    {...props}
  >
    <Path d="M12 5.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" />
    <Path d="M12 5.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" />
    <Path d="M5 20h14V6H5v14Z" />
    <Path d="M11 15.17 8.83 13 11 10.83 9.59 9.41 6 13l3.59 3.59L11 15.17Z" />
    <Path d="M14.41 16.59 18 13l-3.59-3.59L13 10.83 15.17 13 13 15.17l1.41 1.42Z" />

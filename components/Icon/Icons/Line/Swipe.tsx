...
const Icon = ({ size = 46, color = 'currentColor', ...props }) => (
  <Svg
    ...
    {...props}
  >
    <Path d="M20.5 2v2.02A13.413 13.413 0 0 0 12 1C8.78 1 5.82 2.13 3.5 4.02V2H2v5h5V5.5H4.09c2.11-1.86 4.88-3 7.91-3 3.03 0 5.79 1.14 7.91 3H17V7h5V2h-1.5Z" />
